    ...
    <div className="about">
      <Element name="aboutMe" className="about__section">
        ...
        <div className="about__section-content">
            ...
            interest in functional programming and data integration, has
            ...
            environment. With a commitment to continuous learning and a love for
      ...
      <Element name="experience" className="about__section">
        ...
        <div className="experience__item">
          ...
          <ul>
            <li>
              Conducted personalized client consultations, identifying coverage
              gaps, and recommending tailored insurance solutions, resulting in
              a 15% increase in cross-selling and upselling opportunities.
            </li>
            <li>
              Effectively handled customer inquiries related to policy
              information, renewals, cancellations, and updates, maintaining a
        ...
        <div className="experience__item">
          ...
          <ul>
            <li>
              Analyzed financial data and implemented cost-saving strategies,
              resulting in a 12% reduction in operating expenses without
        ...
        <div className="experience__item">
          <h4>Accounting Assistant | Miami Sedation & Cosmetic Dentistry</h4>
          <p>JAN 2014 - JAN 2019, MIAMI, FL</p>
          <ul>
            <li>
              Maintained accurate financial records and expense tracking,
              ensuring compliance with accounting standards and a 95% accuracy
              rate in financial reporting.
            </li>
            <li>
